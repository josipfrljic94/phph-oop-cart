      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#">
            <svg class="m-0 mb-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-bag-plus" viewBox="0 0 16 16">
...
<!-- <button class="button btn " id="addeeve">eve</button> -->
<!-- end navbar -->

<div class="container-fluid">
    <div class="row mx-auto px-auto px-1 pt-3  " id='gcontainer'>
